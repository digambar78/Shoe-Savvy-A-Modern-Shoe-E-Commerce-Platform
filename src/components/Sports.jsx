            ...
            <div id="sport-section1">
                <div className="box" id="box-1">
                    <a href="#sport-section2">
                        ...
                        <img src="/images/bg-img/bg-20.webp" alt="" />
                    </a>
                </div>
                <div className="box" id="box-2">
                    <a href="#sport-section2">
                        ...
                        <img src="/images/bg-img/bg-21.webp" alt="" />
                    </a>
                </div>
                <div className="box" id="box-3">
                    <a href="#sport-section2">
                        ...
                        <img src="/images/bg-img/bg-22.webp" alt="" />
                    </a>
                </div>
                <div className="box" id="box-4">
                    <a href="#sport-section2">
                        ...
                        <img src="/images/bg-img/bg-23.webp" alt="" />
                    </a>
                </div>
            </div>
            <div id="sport-section2">
                <button id="filter" onClick={toggleSidebar} style={{ display: sidebarOpen ? 'inline' : 'none' }}>Filter
                    <img src="/images/logo/down.svg" alt="" />
                </button>
                <div className={`sidebar ${sidebarOpen ? 'sidebarGo' : ''}`}>
                    <img className="cross cross-ani" src="/images/logo/cross.svg" alt="" width="17px" onClick={toggleSidebar} />
                    <div className="info">

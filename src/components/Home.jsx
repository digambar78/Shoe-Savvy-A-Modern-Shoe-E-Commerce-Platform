...
function Home() {
    return (
        <>
            ...
            <div id="shoe-category">
                <div className="box" id="box-1">
                    ...
                    <Link to={'/men'} className='navlink'>
                        <button>Explore All <img src="/images/shoe-category/arrow-right.svg" alt="" /></button>
                    </Link>
                </div>
                                ...
                                <div className="shoe-item" id={shoe.id}>
                                    ...
                                    <div className="social-icons">
                                        <a href="#" className="icon" onClick={(e) => e.preventDefault()}>
                                            <img className="icon" src="/images/social-icon-img/menu.svg" alt="" />
                                        </a>
                                        <a href="#" className="icon" onClick={(e) => e.preventDefault()}>
                                            <img className="icon" src="/images/social-icon-img/search.svg" alt="" />
                                        </a>
                                        <a href="#" className="icon" onClick={(e) => e.preventDefault()}>
                                            <img className="icon" src="/images/social-icon-img/like.svg" alt="" />
                                        </a>
                                    </div>
                                </div>
                            </Link>
            ...
            <div id="choice">
                <div className="box" id="box-1">
                    <img src="/images/bg-img/bg-17.webp" alt="" />
                    <div className="info">
                        <h2>Running Shoes</h2>
                        <Link to={'/men'} className='navlink'>
                ...
                <div className="box" id="box-2">
                    <img src="/images/bg-img/bg-18.webp" alt="" />
                    <div className="info">
                ...
                <div className="box" id="box-3">
                    <img src="/images/bg-img/bg-19.webp" alt="" />
                    <div className="info">
                        <h2>Sport Shoes</h2>
                        <Link to={'/sports'} className='navlink'>
            ...
            <div id="service">
                ...
                <div className="box" id="box-2">
                    <img src="/images/logo/truck.svg" alt="" />
                    <h3>delivery on time</h3>
                    <h4>Definition and measurement</h4>
                </div>
                <div className="box" id="box-3">
                    <img src="/images/logo/secure.svg" alt="" />
                    <h3>secure pament</h3>
                ...
                <div id="instra">
                    <div className="box" id="box-1">
                        <div className="bg-back">
                            <img src="/images/instra-img/img-1.webp" alt="" />
                        </div>
                        <div className="bg-upper">
                            <a href="https://www.instagram.com/web.cbum/" target='_blank'><img src="/images/social-icon-img/instagram.svg" alt="" /></a>
                        </div>
                    </div>
                    <div className="box" id="box-2">
                        <div className="bg-back">
                            <img src="/images/instra-img/img-2.webp" alt="" />
                        </div>
                        <div className="bg-upper">
                            <a href="https://www.instagram.com/web.cbum/" target='_blank'><img src="/images/social-icon-img/instagram.svg" alt="" /></a>
                        </div>
                    ...
                    <div className="box" id="box-3">
                        <div className="bg-back">
                            <img src="/images/instra-img/img-3.webp" alt="" />
                        </div>
                        <div className="bg-upper">
                            <a href="https://www.instagram.com/web.cbum/" target='_blank'><img src="/images/social-icon-img/instagram.svg" alt="" /></a>
                        </div>
                    ...
                    <div className="box" id="box-4">
                        <div className="bg-back">
                            <img src="/images/instra-img/img-4.webp" alt="" />
                        </div>
                        <div className="bg-upper">
                            <a href="https://www.instagram.com/web.cbum/" target='_blank'><img src="/images/social-icon-img/instagram.svg" alt="" /></a>
                        </div>
                    ...
                    <div className="box" id="box-5">
                        <div className="bg-back">
                            <img src="/images/instra-img/img-5.webp" alt="" />
                        </div>
                        <div className="bg-upper">
                            <a href="https://www.instagram.com/web.cbum/" target='_blank'><img src="/images/social-icon-img/instagram.svg" alt="" /></a>
                        </div>

  ...
  return (
    <>
          ...
          {TeamSection.map(member => (
            <div className="box" key={member.id}>
              ...
              <div className="social-icons">
                ...
                <a href="https://www.linkedin.com/in/digambarsingh1477/" target='blank' className="icon"><img src="/images/social-icon-img/linkedin.svg" alt="" /></a>
      ...
      <div id="contact">
        ...
        <div className="video">
          <a href="https://maps.app.goo.gl/vucM3MC9NdscVyc69" target="_blank">
            <video autoPlay muted loop>
              <source src='video/Lovely.mp4' />
            </video>
          </a>
        </div>
      </div>
